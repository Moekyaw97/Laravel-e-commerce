    ...
    <body class="app sidebar-mini">
        ...
        <header class="app-header">
            <a class="app-header__logo" href="index.html">
                <img src="{{ asset('logo/mk-min.png') }}" style="width: 50px; height: 50px">
                Online Shop
            </a>
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user">{{-- <img class="app-sidebar__user-avatar" src="{{ asset(Auth::user()->profile) }}" style="width: 50px; height: 50px; object-fit: cover;" alt="User Image"> --}}
                <div>
                    <p class="app-sidebar__user-name">Name: {{ Auth::user()->name }} </p><br>
    ...
    Role: {{ Auth::user()->roles()->pluck('name')[0] }} 
            ...
            <ul class="app-menu">
               ...
               {{--  <li>
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='order' ? 'active' :'' }}" href="{{ route('order') }}">
               ...
               {{--  <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='customer' ? 'active' :'' }}" href="{{ route('customer') }}">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='brand' ? 'active' :'' }}" href="{{ route('brands.index') }}">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='item' ? 'active' :'' }}" href="{{ route('item.index') }}">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='subcategory' ? 'active' :'' }}" href="{{ route('subcategorys.index') }}">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2) ==='category' ? 'active' :'' }}" href="{{ route('category.index') }}">
