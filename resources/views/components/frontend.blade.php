...
<div class="header__top__right__language">
  {{--   <img src="{{ asset(Auth::user()->profile) }}" alt="" class="userprofile"> --}}
    ...
    <ul>
      {{--   <li><a href="#"> Profile </a></li> --}}
        <li><a href="{{ route('product') }}"> Order </a></li>
        <li>
            ...
            <div class="row">
                <div class="col-lg-3 ml-5">
                    <div class="header__logo">
                        <a href="{{ route('index') }}"><img src="{{ asset('frontend/img/online4.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <nav class="header__menu">
                        <ul class="app-menu">
                            ...
                            <li class="{{Request::segment(0)==='index' ? 'active' :''}}">
                                <a class="app-menu_item " href="{{ route('index') }}">Home</a>
                            </li>
                            <li class="{{Request::segment(1)==='product' ? 'active' :''}}">
                                <a class="app-menu_item " href="{{ route('product') }}"> Products </a>
                            </li>
                            <li class="{{Request::segment(1)==='brand' ? 'active' :''}}"><a  href="#"> Brands </a>
                                <ul class="header__menu__dropdown">
                                    @foreach($data[0] as $brand)
                                        <li><a class="app-menu_item " href="{{ route('brand',$brand->id) }}">{{ $brand->name }}</a></li>
                                    @endforeach
                                    
                                </ul>
                            </li>
                            <li class="{{Request::segment(1)==='cart' ? 'active' :''}}"><a class="app-menu_item " href="{{ route('cart') }}"> Cart </a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li>
                                <a class="app-menu_item {{Request::segment(1)==='cart' ? 'active' :''}}" href="{{ route('cart') }}"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti"></span></a>
                            </li>
                        </ul>
                        <a href="{{ route('cart') }}">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg bg-white">
                        <div class="row">
                            <div class="col-8">
                            ...
                            <div class="col-4">
                                <img src="{{ asset($data[2][0]->logo) }}" class="img">
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="{{ route('index') }}"><img src="{{ asset('') }}" alt=""></a>
                        </div>
                        <ul>
